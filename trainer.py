...
def train():
    """ Executes training procedure that includes:
            ...
            4. Initialize variables in the model and merge all summaries
            ...
            7. Configure operation that TF should run depending on the step number
            8. Save the model checkpoint periodically.
    """
    #1. Check that the provided dataset can be processed
